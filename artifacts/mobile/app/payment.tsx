...
const DEFAULT_WA_MSG = "Hello Coach TinaBarks, I need help with CoreFit.";
          ...
          {step === "instructions" && (
            <View>
              ...
              <TouchableOpacity
                onPress={() => {
                  Haptics.selectionAsync();
                  openWhatsApp("Hi Coach TinaBarks, I need help with my Airtel Money payment for CoreFit.");
                }}
                activeOpacity={0.8}
          ...
          {step === "success" && (
            <View style={styles.successWrap}>
              ...
              <TouchableOpacity
                onPress={() => {
                  Haptics.selectionAsync();
                  openWhatsApp("Hi Coach TinaBarks, I just submitted my payment for CoreFit Premium. Please confirm when it is approved. Thank you!");
                }}
                activeOpacity={0.8}
