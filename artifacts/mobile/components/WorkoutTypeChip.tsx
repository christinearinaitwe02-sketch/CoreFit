...
export type WorkoutType = "cardio" | "strength" | "hiit" | "yoga" | "cycling" | "other";
...
> = {
  cardio: { label: "Cardio", icon: "activity", color: "#FF6B6B" },
...
export function getWorkoutMeta(type: WorkoutType) {
  return WORKOUT_META[type] ?? WORKOUT_META.other;
}
