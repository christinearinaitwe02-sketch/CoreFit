          ...
          <tr>
            <td style="padding:40px 40px 32px;">
                ...
                <tr>
                  <td align="center">
                    <div style="background:#F1E4FA;border-radius:16px;padding:24px 40px;display:inline-block;margin-bottom:28px;">
                      <p style="margin:0 0 4px;font-size:12px;font-weight:600;color:#6A0DAD;letter-spacing:1px;text-transform:uppercase;">Your reset code</p>
              ...
              <p style="margin:0 0 16px;font-size:14px;color:#777;line-height:1.6;">
                Enter this code in the app to set a new password. If you didn't request a password reset, you can safely ignore this email — your account is not at risk.
              </p>

              <div style="background:#FFF7ED;border-left:4px solid #F59E0B;border-radius:0 8px 8px 0;padding:12px 16px;margin-bottom:8px;">
          ...
          <tr>
            <td style="background:#F9F9F9;border-top:1px solid #EEEEEE;padding:20px 40px;text-align:center;">
              <p style="margin:0;font-size:12px;color:#999;line-height:1.6;">
                ...
                Questions? Contact your coach on WhatsApp: <a href="https://wa.me/256702568383" style="color:#6A0DAD;text-decoration:none;">+256 702 568 383</a>
              </p>
            </td>
          </tr>
